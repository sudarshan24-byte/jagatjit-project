...
const Navbar = ({ pageName, link1, link2, link3, handleSectionChange }) => {
    ...
    return (
        <div className='fixed top-0 z-40'>
            <div className='relative mb-2'>
                ...
                <div className='flex justify-between text-sm w-full md:w-[30rem] cursor-pointer absolute -bottom-3 z-30 px-10 space-x-3'>
                    ...
                    <Link className='bg-primary-bg text-secondary px-2 text-xs md:text-sm md:px-3 py-1 border-b border-secondary'>
                        {link1}
                    </Link>
                    <button
                        // onClick={() => handleSectionChange('Milk Products')}
                        className='bg-primary-bg text-secondary px-2 text-xs md:text-sm md:px-3 py-1 border-b border-secondary'>
                        {link2}
                    </button>
                    <button
