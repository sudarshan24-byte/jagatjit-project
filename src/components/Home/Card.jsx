...
const Card = ({ image, text, link }) => {
    return (
        <Link to={link} className="max-w-lg mx-auto bg-transparent">
            <div className="relative">
                <img
                    src={image}
                    alt="Card"
                    className="object-cover bg-cover w-[23rem] lg:w-[25rem] h-60 mb-8 md:mb-5 border border-secondary/25 rounded-md lg:h-64"
                />
                <div className="absolute top-1/2 left-0 right-0 transform -translate-y-1/2 bg-black/70">
